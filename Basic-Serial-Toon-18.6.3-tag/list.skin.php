...
<section class="board-list<?php echo (G5_IS_MOBILE) ? ' font-14' : '';?>"> 
	<?php if($is_stag) @include_once($board_skin_path.'/tags.skin.php'); ?>
			...
			<div class="list-btn">
				<div class="form-group pull-right">
					<div class="btn-group dropup" role="group">
						...
						<?php if ($write_href) { ?><a role="button" href="<?php echo $write_href ?>" class="btn btn-<?php echo $btn2;?> btn-sm"><i class="fa fa-pencil"></i> 표지등록</a><?php } ?>
					</div>
				</div>
					...
					<div class="btn-group" role="group">
						...
						<?php if ($is_checkbox) { ?>
							<?php if ($is_serial_admin) { ?>
								<a role="button" href="./board.php?bo_table=<?php echo $bo_table;?>&amp;act=off" class="btn btn-<?php echo $btn1;?> btn-sm"><i class="fa fa-bars"></i><span class="hidden-xs"> 표지글</span></a>
							<?php } else { ?>
								<a role="button" href="./board.php?bo_table=<?php echo $bo_table;?>&amp;act=on" class="btn btn-<?php echo $btn1;?> btn-sm"><i class="fa fa-bars"></i><span class="hidden-xs"> 전체글</span></a>
							<?php } ?>
							<button type="submit" name="btn_submit" value="표지지정" onclick="document.pressed=this.value" class="btn btn-<?php echo $btn2;?> btn-sm"><i class="fa fa-book"></i><span class="hidden-xs"> 표지지정</span></button>
