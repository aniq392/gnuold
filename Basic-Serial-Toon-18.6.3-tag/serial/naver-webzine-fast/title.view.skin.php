				...
				<div class="table-responsive">
					<table class="table">
						...
						<tr>
							...
							<td style="min-width:260px;"><?php echo $tag_first;?> </td>
						</tr>
					</table>
				</div>
				...
				<div class="row">
					...
					<table class="table" style="border-bottom: 2px solid #333; border-top: 1px solid #ddd;">
						...
						<tr>
							...
							<?php	}	?>
								<button onclick="location.href='<?php echo $next_href;?>'" class="btn btn-blue btn-sm"  data-original-title="첫회보기" data-toggle="tooltip">첫회보기</button>
								<button onclick="location.href='<?php echo G5_BBS_URL;?>/tag.php?q=<?php echo $tag_first;?>'" class="btn btn-blue btn-sm"  data-original-title="작가의 다른작품" data-toggle="tooltip"> 작가의 다른작품</button>
