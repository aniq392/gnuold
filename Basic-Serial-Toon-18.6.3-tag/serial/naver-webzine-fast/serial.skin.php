	...
	?>
		<li class="list-item<?php echo $li_css;?>">
			...
			<div class="wr-subject">
				<a id="fast_a_<?php echo $i; ?>" href="<?php echo $list[$i]['href']; ?>" class="item-subject"<?php echo $list[$i]['target'];?><?php echo $is_modal_js;?>>
				...
				<!-- 빠른 내용 보기 -->
                 <div class="fast_content" id="fast_content_<?php echo $i; ?>"><?php echo $list[$i]['wr_content'] ?></div>
                 <script>
					$('#fast_a_<?php echo $i; ?>').hover(function() {
						$('#fast_content_<?php echo $i; ?>').css('display','block');
					}, function() {
						$('#fast_content_<?php echo $i; ?>').css('display','none');
					});
				</script>
				<!-- 빠른 내용 보기 끝 -->
