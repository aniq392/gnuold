...
#stv_list {position:fixed;width:88px;border:1px solid #eee;background:#fff; }
	...
	<div class="container">
		...
		<aside id="stv">
			<div id="stv_list">
				...
				<ul id="stv_nb">
				<?php if ($prev_href) { ?>
					<li><a href="<?php echo $prev_href.$modal_query; ?>" data-original-title="<nobr>이전화</nobr>" data-toggle="tooltip" data-placement="top" data-html="true"> <i class="fa fa-arrow-left" aria-hidden="true"></i> </a></li>
					<?php } else { ?>
					<li><a href="#" data-original-title="<nobr>이전화가없습니다</nobr>" data-toggle="tooltip" data-placement="top" data-html="true" style="cursor: not-allowed;"> <i class="fa fa-arrow-left" aria-hidden="true"></i> </a></li>
				<?php }?>
				<?php if ($next_href) { ?>
					<li><a href="<?php echo $next_href.$modal_query; ?>"data-original-title="<nobr>다음화</nobr>" data-toggle="tooltip" data-placement="top" data-html="true"> <i class="fa fa-arrow-right" aria-hidden="true"></i> </a></li>
					<?php } else { ?>
					<li><a href="#" data-original-title="<nobr>다음화가없습니다</nobr>" data-toggle="tooltip" data-placement="top" data-html="true" style="cursor: not-allowed;"> <i class="fa fa-arrow-right" aria-hidden="true"></i> </a></li>
				<?php }?>
					<li><a href="./board.php?bo_table=<?php echo $bo_table;?>&amp;wr_id=<?php echo $sid;?><?php echo $qstr;?>" class="btn_lst" data-original-title="<nobr>목록</nobr>" data-toggle="tooltip" data-placement="top" data-html="true">목록</a></li>
				</ul>
